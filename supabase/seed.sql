...
('custom-1773122073507', 1000, '우주선 Logic호', 'LoTC', 2026,
  ARRAY['classical-mechanics'],
  E'우주 탐사선 Logic호의 역학 문제입니다.',
  E'풀이를 참고하세요.',
  '2026-03-10', '2026-03-10'),

('ipho-2023-1', 1001, 'Relativistic Particle in Magnetic Field', 'IPhO 2023', 2023,
...
('kpho-2022-3', 1002, '열역학적 엔진의 효율', 'KPhO 2022', 2022,
...
('icho-2023-2', 1003, 'Coordination Chemistry of Transition Metals', 'IChO 2023', 2023,
...
('kmo-2023-1', 1004, '정수론: 소수의 성질', 'KMO 2023', 2023,
...
('ibo-2022-1', 1005, 'Gene Expression and Regulation', 'IBO 2022', 2022,
...
('snu-physics-2023', 1006, '양자역학: 무한 퍼텐셜 우물', '서울대 물리학과 기출', 2023,
...
('kpho-2023-5', 1007, '레너드-존스 퍼텐셜과 분자 간 상호작용', 'KPhO 2023', 2023,
